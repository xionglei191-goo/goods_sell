...
export const agentCapabilities: readonly AgentCapability[] = [
  ...
  cap({
    ...
    module: "合规",
    href: "/terms",
    description: "查看平台注册、下单、经销商入驻和后台使用的服务协议。",
    roles: allRoles,
    capabilities: ["服务协议", "用户协议", "注册协议", "使用条款", "条款"],
    examples: ["服务协议在哪"],
  }),
  cap({
    id: "legal.privacy",
    ...
    module: "合规",
    href: "/privacy",
    description: "查看个人信息收集、使用、保存和用户权利说明。",
    roles: allRoles,
    capabilities: ["隐私政策", "个人信息保护", "隐私条款", "数据使用", "授权同意"],
    examples: ["隐私政策在哪"],
  }),
  cap({
    id: "auth.forbidden",
  ...
  cap({
    ...
    description: "查看配送单、配送客户、配送状态、异常和送达记录。",
    permission: "delivery:manage",
    toolName: "delivery_summary",
    capabilities: ["物流配送", "配送管理", "配送订单", "客户配送订单", "待发货", "配送中", "配送异常", "配送详情"],
    examples: ["物流配送在哪", "有哪些客户有配送订单"],
  }),
  cap({
    id: "marketing.home",
    title: "运营营销",
